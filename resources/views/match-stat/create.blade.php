<x-app-layout>
   ...
   <h1 class="p-4 text-center text-2xl font-bold">{{ __('Add Match Statistics') }}</h1>
   <form action="{{ route('stats.store', $match) }}" method="POST" class="p-6">
   @csrf
   <div class="grid grid-cols-2 gap-y-6 gap-x-12">

    <div>
    <label class="block font-medium text-gray-700 mb-1">{{ __('Shots') }} <span class="text-red-500">*</span></label>
    <input type="number" name="shots" value="{{ old('shots') }}" class="rounded-md w-full" min="0">
    ...
    <input type="number" name="goals" value="{{ old('goals') }}" class="rounded-md w-full" min="0">
    ...
    <input type="number" name="passes" value="{{ old('passes') }}" class="rounded-md w-full" min="0">
    ...
    <input type="number" name="assists" value="{{ old('assists') }}" class="rounded-md w-full" min="0">
    ...
    <input type="number" name="yellows" value="{{ old('yellows') }}" class="rounded-md w-full" min="0" max="2">
    ...
    <input type="number" name="reds" value="{{ old('reds') }}" class="rounded-md w-full" min="0" max="1">
    ...
    <input type="number" name="headers" value="{{ old('headers') }}" class="rounded-md w-full" min="0" >
    ...
    <input type="number" name="rating" value="{{ old('rating') }}" class="rounded-md w-full" step="0.1" min="0" max="10">
   ...
   <label class="block font-medium text-gray-700 mb-1">{{ __('Report') }} </label>
    <textarea name="report" class="w-full">{{ old('report') }}</textarea>
    <x-input-error :messages="$errors->first('rating')" class="mt-2" />
   </div>
