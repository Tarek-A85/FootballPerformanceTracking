<x-tournament-layout :tournament="$tournament">
   ...
   <h1 class="p-4 text-center text-2xl font-bold">{{ __('Create New Match with :attribute', ['attribute' => $tournament['name_'. app()->getLocale()]]) }}</h1>
   <form action="{{ route('matches.store') }}" method="POST" class="p-6">
    ...
    <input type="hidden" name="form_page" value="tournament_page">
